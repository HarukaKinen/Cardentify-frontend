	...
	>
		<div class="mx-auto px-4">
			<div class="flex h-16 items-center justify-between">
				...
				><a href="https://github.com/HarukaKinen/Cardentify" target="_blank">
					<svg
											...
											>
												...
												<div class="p-6">
													...
													<ul class="w-full">
														<li
															v-if="card.bin"
															class="w-full border-b-2 border-neutral-100 border-opacity-50 px-6 py-3"
														>
															<span
																v-for="(
																	bin, index
														...
														<li
															v-if="
																card.card.brand
															"
															class="w-full border-neutral-100 border-opacity-50 px-6 py-3"
														>
															{{
																card.card.brand
															}}
